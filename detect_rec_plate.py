...
def load_model(weights, device):  #加载yolov8 模型
    mo = attempt_load_weights(weights,device=device)  # load FP32 model
    return mo
...
if __name__ == "__main__":
    ...
    parser.add_argument('--detect_model', nargs='+', type=str, default=r'./weights/sord.pt', help='model.pt path(s)')  #yolov8检测模型
